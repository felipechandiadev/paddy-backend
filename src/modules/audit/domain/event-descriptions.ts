/**
 * Diccionario de descripciones amigables de eventos para usuarios no técnicos
 * Mapea eventCode a una descripción clara en español
 */
 ...
 * @param eventCode - Código del evento (ej: AUTH.LOGIN.ATTEMPT)
 * @returns Descripción en español legible para usuarios no técnicos
 */
export function getEventDescription(eventCode: string): string {
